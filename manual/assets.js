...
var show = $('<a class=\'control show\'> + </a>');
show.click(function () {
  $('#content article:not(".active") > a').trigger('click');
});
//$('#content').prepend(show);

var hide = $('<a class=\'control hide\'> - </a>');
hide.click(function () {
...
//Added by Remy (to put the Show/Hide menu on the nav part)
$('#sidebar > h1').append($('<span>&emsp;[</span>'))
.append(hide).append($('<span>|</span> '))
.append(show).append($('<span>]</span> '));
});
